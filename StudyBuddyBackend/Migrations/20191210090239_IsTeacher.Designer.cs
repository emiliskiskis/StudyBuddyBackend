...
namespace StudyBuddyBackend.Migrations
{
    ...
    [Migration("20191210090239_IsTeacher")]
    partial class IsTeacher
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyBuddyBackend.Database.Entities.Feedback", b =>
                {
                    ...
                    b.Property<string>("RevieweeUsername")
                        .HasColumnType("character varying");
                    ...
                    b.HasKey("AuthorUsername", "RevieweeUsername");

                    b.HasIndex("RevieweeUsername");
            ...
            modelBuilder.Entity("StudyBuddyBackend.Database.Entities.TeacherInfo", b =>
                {
                    b.Property<string>("Username")
                        .HasColumnType("character varying");
            ...
            modelBuilder.Entity("StudyBuddyBackend.Database.Entities.TeacherSubject", b =>
                {
            ...
            modelBuilder.Entity("StudyBuddyBackend.Database.Entities.Feedback", b =>
                {
                    ...
                    b.HasOne("StudyBuddyBackend.Database.Entities.User", "Reviewee")
                        .WithMany()
                        .HasForeignKey("RevieweeUsername")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("StudyBuddyBackend.Database.Entities.TeacherSubject", b =>
                {
                    ...
                    b.HasOne("StudyBuddyBackend.Database.Entities.TeacherInfo", "User")
